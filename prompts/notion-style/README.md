...
<table>
    <tr>
      <td align="center" width="33%"><img src="./previews/0.webp" alt="Notion Style: Title page" width="260"><br><sub>Title page</sub></td>
      <td align="center" width="33%"><img src="./previews/1.webp" alt="Notion Style: Callout and toggles" width="260"><br><sub>Callout and toggles</sub></td>
      <td align="center" width="33%"><img src="./previews/2.webp" alt="Notion Style: Database table" width="260"><br><sub>Database table</sub></td>
    </tr>
    <tr>
      <td align="center" width="33%"><img src="./previews/3.webp" alt="Notion Style: Board view" width="260"><br><sub>Board view</sub></td>
      <td align="center" width="33%"><img src="./previews/4.webp" alt="Notion Style: Checklist and columns" width="260"><br><sub>Checklist and columns</sub></td>
      <td align="center" width="33%"><img src="./previews/5.webp" alt="Notion Style: Quote and linked pages" width="260"><br><sub>Quote and linked pages</sub></td>
    </tr>
</table>
