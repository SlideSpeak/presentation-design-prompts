...
<table>
    <tr>
      <td align="center" width="33%"><img src="./previews/0.webp" alt="Netflix Culture Deck: Title" width="260"><br><sub>Title</sub></td>
      <td align="center" width="33%"><img src="./previews/1.webp" alt="Netflix Culture Deck: Values roster" width="260"><br><sub>Values roster</sub></td>
      <td align="center" width="33%"><img src="./previews/2.webp" alt="Netflix Culture Deck: Section opener" width="260"><br><sub>Section opener</sub></td>
    </tr>
    <tr>
      <td align="center" width="33%"><img src="./previews/3.webp" alt="Netflix Culture Deck: Statement" width="260"><br><sub>Statement</sub></td>
      <td align="center" width="33%"><img src="./previews/4.webp" alt="Netflix Culture Deck: The keeper test" width="260"><br><sub>The keeper test</sub></td>
      <td align="center" width="33%"><img src="./previews/5.webp" alt="Netflix Culture Deck: Context, not control" width="260"><br><sub>Context, not control</sub></td>
    </tr>
</table>
